...
public class ViolationsManager {
    ...
    private void updatePartner(ConstraintPartner partner, ScheduledItem partnerItem, ViolationsContainer container,
        ...
        if (partnerViolator != null) {
            ...
            if (!violationsTree.remove(partnerViolator)) {
                throw new SchedulingException("Fixed item?");
            }
            int newHardValue = partnerViolator.hardViolationsValue
    ...
    private void checkUpdateValid(Violator violator, int newHardViolationsValue, int newSoftViolationsValue) throws ViolatorUpdateInvalid {
        if (newHardViolationsValue > violator.hardViolationsValue
                || (newHardViolationsValue == violator.hardViolationsValue && newSoftViolationsValue > violator.softViolationsValue)) {
            throw new ViolatorUpdateInvalid();
        }
    }
    ...
    // public int getHardViolationsValue(ScheduledItem item) {
    // Integer value = hardViolationsValue.get(item);
    // return value == null ? 0 : value;
    // }
    //
    // public int getHardViolationsSum() {
    // if (hardViolationsSum == null) {
    // int sum = 0;
    // for (Integer value : hardViolationsValue.values()) {
    // sum += value;
    // }
    // hardViolationsSum = sum;
    // }
    // return hardViolationsSum;
    // }
    //
    // public int getSoftViolationsSum() {
    // if (softViolationsSum == null) {
    // int sum = 0;
    // for (Integer value : softViolationsValue.values()) {
    // sum += value;
    // }
    // softViolationsSum = sum;
    // }
    // return softViolationsSum;
    // }
    //
    // public int getSoftViolationsValue(ScheduledItem item) {
    // Integer value = softViolationsValue.get(item);
    // return value == null ? 0 : value;
    // }
    ...
    public ViolatorValues checkViolationsForPlan(SchedulePlan plan) {
        ...
        // TODO: pair-versteosse werden doppelt gezählt
