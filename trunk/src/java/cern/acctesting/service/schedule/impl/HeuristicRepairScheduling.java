        ...
        while (violator != null) {
            ...
            if (!wasPossible) {
                ...
                if (violator == null && hardConstraintsSatisfied) {
                    /*
                     * the hard constraints are satisfied and the soft constraints can not be refined any further
                     * without breaking something
                     */
                    break;
                } else if (violator == null && !hardConstraintsSatisfied) {
                    /*
                     * a suitable place could not be found, not even at the end of the plan. The reason could be that
                     * some constraints are violated - after moving the item to the end of the plan - even though they
                     * are not violated now. The plan is captured in a local optimum and has to be lifted out of it in
                     * order to proceed its search.
                     */
